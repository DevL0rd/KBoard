...
PlasmoidItem {
    ...
    readonly property string visibleWatch: "busctl --user wait org.devl0rd.KBoard /KBoard org.devl0rd.KBoard VisibleChanged"
    ...
    toolTipSubText: ready ? i18n("%1\nClick to %2 · Middle-click for %3", statusText, keyboardVisible ? i18n("hide") : i18n("show"), panelName(Plasmoid.configuration.middleClickPanel)) : statusText
    ...
    function sync() {
        if (!running)
            return
        call("IsVisible", [], value => root.keyboardVisible = value)
